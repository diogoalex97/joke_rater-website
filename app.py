...
if  st.session_state.get("submit", False):
    if joke_input:
        ...
        st.write("(Note that this rate is definitely not reliable!! I'll fix it one day)",unsafe_allow_html=True)
        ...
        st.sidebar.write("")
        st.sidebar.write("")
        st.sidebar.write("<h7>Get it? Byte?</h7>",unsafe_allow_html=True)
